    ...
    wifiRetryPressedCallback(0)
{
    ...
    wifiRetryButton.setLabelText(touchgfx::TypedText(T___SINGLEUSE_6A1U));
    wifiRetryButton.setLabelColor(touchgfx::Color::getColorFromRGB(235, 235, 235));
    wifiRetryButton.setLabelColorPressed(touchgfx::Color::getColorFromRGB(235, 235, 235));
    wifiRetryButton.setAction(buttonCallback);

    wifiConnectionStatus.setPosition(151, 152, 178, 31);
    wifiConnectionStatus.setColor(touchgfx::Color::getColorFromRGB(235, 235, 235));
    ...
    connectingText.setColor(touchgfx::Color::getColorFromRGB(235, 235, 235));
    connectingText.setLinespacing(0);
    Unicode::snprintf(connectingTextBuffer, CONNECTINGTEXT_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_47PP).getText());
